...
from gns3util.lazy_group import LazyGroup
...
@click.group(
    ...
    lazy_subcommands={
        ...
        "install-completions": "utils.install_completion",
    },
)
@click.option(
    "--server",
...
@click.option(
    ...
    default=True,
    flag_value=False,
    help="Ignore unsigned SSL-Certificates",
)
@click.option(
    "--key_file",
    "-k",
    ...
    help="Set a location for a keyfile to use",
)
@click.pass_context
