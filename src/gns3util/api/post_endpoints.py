...
class GNS3PostAPI(GNS3APIClient):
    ...
    def login_controller(self):
        return self._api_call("login", method="POST")
    ...
    def create_node_from_template(self, project_id, template_id, data):
    ...
    # appliance endpoints
    def appliance_create_version(self, appliance_id, data):
        return self._api_call(f"appliances/{appliance_id}/version", method="POST", data=data)

    def appliance_install(self, appliance_id, version):
