...
class GNS3DeleteAPI(GNS3APIClient):
    ...
    def delete_user(self, user_id):
        return self._api_call(
            f"access/users/{user_id}", method="DELETE", verify=self.verify
        )
    ...
    def delete_group(self, group_id):
        return self._api_call(
            f"access/groups/{group_id}", method="DELETE", verify=self.verify
        )
    ...
    def delete_role(self, role_id):
        return self._api_call(
            f"access/roles/{role_id}", method="DELETE", verify=self.verify
        )
    ...
    def delete_ace(self, ace_id):
        return self._api_call(
            f"access/acl/{ace_id}", method="DELETE", verify=self.verify
        )
    ...
    def delete_image(self, image_path):
        return self._api_call(
            f"images/{image_path}", method="DELETE", verify=self.verify
        )
    ...
    def delete_template(self, template_id):
        return self._api_call(
            f"templates/{template_id}", method="DELETE", verify=self.verify
        )
    ...
    def delete_project(self, project_id):
        return self._api_call(
            f"projects/{project_id}", method="DELETE", verify=self.verify
        )
    ...
    def delete_compute(self, compute_id):
        return self._api_call(
            f"computes/{compute_id}", method="DELETE", verify=self.verify
        )
    ...
    def delete_pool_resource(self, pool_id, resource_id):
        return self._api_call(
            f"pools/{pool_id}/resources/{resource_id}",
            method="DELETE",
            verify=self.verify,
        )
