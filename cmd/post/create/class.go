...
- Students assigned to both the class group and their respective student groups`,
  ...
  gns3util -s https://controller:3080 create class --file class.json

  # Launch interactive class creation
  gns3util -s https://controller:3080 create class --interactive

  # Create class with specific name
  gns3util -s https://controller:3080 create class --file class.json --name "CS101"
		`,
		RunE: runCreateClass,
	}
