...
func NewUpdateProjectCmd() *cobra.Command {
	...
	cmd.Flags().BoolVarP(&autoClose, "auto-close", "", true, "Close project when last client leaves")
	cmd.Flags().BoolVarP(&autoOpen, "auto-open", "", false, "Project opens when GNS3 starts")
