## gns3util node node-isolate

Isolate a node (suspend all attached links)

### Synopsis

Isolate a node by suspending all attached links on the GNS3 server.

```
gns3util node node-isolate [project-name/id] [node-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 post node node-isolate [project-name/id] [node-name/id]
```

### Options

```
  -h, --help   help for node-isolate
```
