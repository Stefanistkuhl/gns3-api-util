## gns3util pool resource

Delete a resource from a pool

### Synopsis

Delete a resource from a pool on the GNS3 server.

```
gns3util pool resource [pool-name/id] [resource-id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 pool resource my-pool resource-id
```
