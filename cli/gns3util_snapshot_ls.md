## gns3util snapshot ls

Get the snapshots within a project by name or id
...
```
gns3util snapshot ls [project-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 snapshot ls my-project
```
...
```
  ...
  -h, --help    help for ls
  -m, --multi   Get snapshots from multiple projects
```
