## gns3util group delete

Delete a group

### Synopsis

Delete a group from the GNS3 server.

```
gns3util group delete [group-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 group delete my-group
```
