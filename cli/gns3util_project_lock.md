## gns3util project lock

Lock all drawings and nodes in a project

### Synopsis

Lock all drawings and nodes in a given project on the GNS3 server.

```
gns3util project lock [project-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 project lock my-project
```
