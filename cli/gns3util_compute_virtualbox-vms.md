## gns3util compute virtualbox-vms

Get the virtualbox-vms of a compute by name or id
...
```
gns3util compute virtualbox-vms [compute-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 compute virtualbox-vms my-compute
```

### Options

```
  -h, --help   help for virtualbox-vms
```
