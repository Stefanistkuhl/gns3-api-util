## gns3util pool resources

Get resources of a pool by name or id
...
```
gns3util pool resources [pool-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 pool resources my-pool
```

### Options

```
  -f, --fuzzy   Use fuzzy search to find a pool
  -h, --help    help for resources
  -m, --multi   Get multiple pools
```
