## gns3util image delete

Delete an image

### Synopsis

Delete an image from the GNS3 server.

```
gns3util image delete [image-path] [flags]
```

### Examples

```
gns3util -s https://controller:3080 image delete /path/to/image
```
