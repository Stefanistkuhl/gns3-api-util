## gns3util role role-privilege

Delete a privilege from a role

### Synopsis

Delete a privilege from a role on the GNS3 server.

```
gns3util role role-privilege [role-name/id] [privilege-id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 role role-privilege my-role privilege-id
```

### Options

```
  -h, --help   help for role-privilege
```
