## gns3util role privileges

Get the privileges of a role by id or name
...
```
gns3util role privileges [role-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 role privileges my-role
```
