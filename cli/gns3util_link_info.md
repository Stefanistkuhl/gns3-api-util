...
Get a link within a project by name or id
...
```
gns3util link info [project-name/id] [link-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 link info my-project my-link
```
