## gns3util drawing info

Get a drawing within a project by name or id
...
```
gns3util drawing info [project-name/id] [drawing-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 drawing info my-project my-drawing
```
