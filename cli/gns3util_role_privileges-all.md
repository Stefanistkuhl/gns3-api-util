## gns3util role privileges-all

Get all privileges

### Synopsis

Get all privileges from the GNS3 server.

```
gns3util role privileges-all [flags]
```

### Examples

```
gns3util -s https://controller:3080 role privileges-all
```

### Options

```
  -h, --help   help for privileges-all
```
