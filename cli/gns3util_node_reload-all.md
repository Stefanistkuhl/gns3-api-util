## gns3util node reload-all

Reload all nodes belonging to a project

### Synopsis

Reload all nodes belonging to a given project on the GNS3 server.

```
gns3util node reload-all [project-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 post node reload-all [project-name/id]
```

### Options

```
  -h, --help   help for reload-all
```
