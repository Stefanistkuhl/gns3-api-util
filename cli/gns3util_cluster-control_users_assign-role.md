## gns3util cluster-control users assign-role

Assign a role to an existing user

```
gns3util cluster-control users assign-role <user-id> <role-name> [flags]
```

### Examples

```
  gns3util ctl users assign-role alice viewer
