## gns3util cluster-control users delete

Delete a user's permission record from etcd

```
gns3util cluster-control users delete <user-id> [flags]
```

### Examples

```
  gns3util ctl users delete alice
