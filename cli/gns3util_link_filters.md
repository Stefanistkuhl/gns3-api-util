## gns3util link filters

Get the filters for a link within a project by name or id
...
```
gns3util link filters [project-name/id] [link-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 link filters my-project my-link
```
