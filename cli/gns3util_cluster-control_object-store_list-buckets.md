## gns3util cluster-control object-store list-buckets

List all buckets in the filestore

```
gns3util cluster-control object-store list-buckets [flags]
```

### Options

```
  -h, --help   help for list-buckets
```
