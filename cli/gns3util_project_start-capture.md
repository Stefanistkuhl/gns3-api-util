## gns3util project start-capture

Start a packet capture in a project on a given link

### Synopsis

Start a packet capture in a project on a given link on the GNS3 server.

```
gns3util project start-capture [project-name/id] [link-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 project start-capture my-project my-link
```

### Options

```
  -h, --help   help for start-capture
```
