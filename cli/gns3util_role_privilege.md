## gns3util role privilege

Add a privilege to a role

### Synopsis

Add a privilege to a role on the GNS3 server.

```
gns3util role privilege [role-name/id] [privilege-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 role privilege my-role my-privilege
```
