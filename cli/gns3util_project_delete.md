## gns3util project delete

Delete a project

### Synopsis

Delete a project from the GNS3 server.

```
gns3util project delete [project-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 project delete my-project
```
