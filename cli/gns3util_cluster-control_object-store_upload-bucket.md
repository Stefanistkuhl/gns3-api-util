## gns3util cluster-control object-store upload-bucket

Upload a file to a specific bucket

```
gns3util cluster-control object-store upload-bucket [bucket_id] [file_path] [flags]
```
...
```
  ...
  -h, --help                  help for upload-bucket
  -r, --retention int         Retention period in hours (unset = permanent)
  -t, --type string           Content-Type (default "application/octet-stream")
```
