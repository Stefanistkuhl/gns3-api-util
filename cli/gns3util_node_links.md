...
Get links of a given node in a project by id or name
...
```
gns3util node links [project-name/id] [node-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 node links my-project my-node
```
