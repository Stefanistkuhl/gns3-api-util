## gns3util system notifications

Stream the notification of the controller
...
```
gns3util system notifications [flags]
```

### Examples

```
gns3util -s https://controller:3080 get notifications
```
...
```
  ...
  -t, --timeout int   Timeout in seconds (0 for stream until cancellation) (default 5)
```
