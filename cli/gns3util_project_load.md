## gns3util project load

Load a project from a given path

### Synopsis

Load a project from a given path on the GNS3 server.

```
gns3util project load [project-path] [flags]
```

### Examples

```
gns3util -s https://controller:3080 post project load /path/to/project.gns3project
```
