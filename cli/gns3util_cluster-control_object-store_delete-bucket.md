## gns3util cluster-control object-store delete-bucket

Delete a bucket and all its files (cannot delete global bucket)

```
gns3util cluster-control object-store delete-bucket [bucket_id] [flags]
```
