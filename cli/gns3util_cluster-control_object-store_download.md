## gns3util cluster-control object-store download

Download a file from the cluster filestore

```
gns3util cluster-control object-store download [file_uuid] [output_path] [flags]
```
