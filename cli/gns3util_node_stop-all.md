## gns3util node stop-all

Stop all nodes belonging to a project

### Synopsis

Stop all nodes belonging to a given project on the GNS3 server.

```
gns3util node stop-all [project-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 post node stop-all [project-name/id]
```
