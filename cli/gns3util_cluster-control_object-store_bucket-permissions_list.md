## gns3util cluster-control object-store bucket-permissions list

List all permissions on a bucket

```
gns3util cluster-control object-store bucket-permissions list <bucket-id> [flags]
```

### Examples

```
  gns3util object-store bucket-permissions list <bucket-id>
```
