## gns3util group add-member

Add a user to a group

### Synopsis

Add a user to a group on the GNS3 server.

```
gns3util group add-member [group-name/id] [user-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 group add-member my-group my-user
```
