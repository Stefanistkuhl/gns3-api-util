## gns3util project unlock

Unlock all drawings and nodes in a project

### Synopsis

Unlock all drawings and nodes in a given project on the GNS3 server.

```
gns3util project unlock [project-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 project unlock my-project
```
