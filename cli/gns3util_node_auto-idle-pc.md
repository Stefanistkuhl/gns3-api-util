## gns3util node auto-idle-pc

Get the auto-idle-pc of a node in a project by id or name
...
```
gns3util node auto-idle-pc [project-name/id] [node-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 node auto-idle-pc my-project my-node
```
