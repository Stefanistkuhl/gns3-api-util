## gns3util project stats

Get project-stats by id or name
...
```
gns3util project stats [project-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 project stats my-project
```
