## gns3util link stop-capture

Stop packet capture on a link

### Synopsis

Stop packet capture on a link in a project on the GNS3 server.

```
gns3util link stop-capture [project-name/id] [link-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 link stop-capture my-project my-link
```

### Options

```
  -h, --help   help for stop-capture
```
