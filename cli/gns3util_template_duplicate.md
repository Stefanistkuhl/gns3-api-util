## gns3util template duplicate

Duplicate a template

### Synopsis

Duplicate a template on the GNS3 server.

```
gns3util template duplicate [template-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 template duplicate my-template
```
