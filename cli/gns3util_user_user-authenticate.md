## gns3util user user-authenticate

Authenticate as a user

### Synopsis

Authenticate as a user on the GNS3 server.

```
gns3util user user-authenticate [flags]
```

### Examples

```
gns3util -s https://controller:3080 post user-authenticate
```

### Options

```
  -h, --help   help for user-authenticate
```
