...
sync your cluster config file with the local database
...
```
gns3util cluster config sync [flags]
```
...
```
  ...
  -v, --verbose      Run the command verbose to show all missmatches if they occur.
```
