## gns3util node suspend-all

Suspend all nodes belonging to a project

### Synopsis

Suspend all nodes belonging to a given project on the GNS3 server.

```
gns3util node suspend-all [project-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 post node suspend-all [project-name/id]
```

### Options

```
  -h, --help   help for suspend-all
```
