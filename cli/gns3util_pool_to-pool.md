## gns3util pool to-pool

Add a resource to a pool

### Synopsis

Add a resource (like a project) to a pool on the GNS3 server.

```
gns3util pool to-pool [pool-name/id] [project-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 pool to-pool my-pool my-project
```

### Options

```
  -h, --help   help for to-pool
```
