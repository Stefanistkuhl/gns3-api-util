## gns3util cluster-control object-store file-permissions list

List all permissions on a file

```
gns3util cluster-control object-store file-permissions list <file-uuid> [flags]
```

### Examples

```
  gns3util object-store file-permissions list <file-uuid>
```
