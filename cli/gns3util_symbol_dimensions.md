## gns3util symbol dimensions

Get the dimensions of a symbol by id
...
```
gns3util symbol dimensions [symbol-id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 symbol dimensions symbol-id
```

### Options

```
  -f, --fuzzy   Use fuzzy search to find a symbol
  -h, --help    help for dimensions
  -m, --multi   Get dimensions for multiple symbols
```
