## gns3util compute vmware-vms

Get the vmware-vms of a compute by name or id
...
```
gns3util compute vmware-vms [compute-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 compute vmware-vms my-compute
```

### Options

```
  -h, --help   help for vmware-vms
```
