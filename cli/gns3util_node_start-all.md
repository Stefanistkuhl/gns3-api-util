## gns3util node start-all

Start all nodes belonging to a project

### Synopsis

Start all nodes belonging to a given project on the GNS3 server.

```
gns3util node start-all [project-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 post node start-all [project-name/id]
```

### Options

```
  -h, --help   help for start-all
```
