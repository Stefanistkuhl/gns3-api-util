...
```
gns3util template info [template-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 template info my-template
```

### Options

```
  -f, --fuzzy   Use fuzzy search to find a template
  -h, --help    help for info
  -m, --multi   Get multiple templates
```
