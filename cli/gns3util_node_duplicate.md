## gns3util node duplicate

Duplicate a Node in a Project

### Synopsis

Duplicate a node in a project on the GNS3 server.

```
gns3util node duplicate [project-name/id] [node-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 post node duplicate [project-name/id] [node-name/id]
```
