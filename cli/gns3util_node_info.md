...
Get a node in a project by name or id
...
```
gns3util node info [project-name/id] [node-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 node info my-project my-node
```
