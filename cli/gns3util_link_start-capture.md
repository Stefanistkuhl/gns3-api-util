## gns3util link start-capture

Start packet capture on a link

### Synopsis

Start packet capture on a link in a project on the GNS3 server.

```
gns3util link start-capture [project-name/id] [link-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 link start-capture my-project my-link
```
