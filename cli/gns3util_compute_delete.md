## gns3util compute delete

Delete a compute

### Synopsis

Delete a compute from the GNS3 server.

```
gns3util compute delete [compute-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 compute delete my-compute
```
