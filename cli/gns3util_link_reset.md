...
Reset a link in a project on the GNS3 server.

```
gns3util link reset [project-name/id] [link-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 link reset my-project my-link
```
