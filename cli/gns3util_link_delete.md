## gns3util link delete

Delete a link from a project

### Synopsis

Delete a link from a project on the GNS3 server.

```
gns3util link delete [project-name/id] [link-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 link delete my-project my-link
```
