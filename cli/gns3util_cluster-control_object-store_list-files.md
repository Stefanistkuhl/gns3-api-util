## gns3util cluster-control object-store list-files

List files in a specific bucket

### Synopsis

List files in a specific bucket if no bucket is specified the default bucket is used

```
gns3util cluster-control object-store list-files [bucket_id] [flags]
```
