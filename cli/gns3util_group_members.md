## gns3util group members

Get the members of a group by id or name
...
```
gns3util group members [group-name/id] [flags]
```

### Examples

```
gns3util -s https://controller:3080 group members my-group
```
